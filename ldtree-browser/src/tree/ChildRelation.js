...
var ChildRelation = /** @class */ (function () {
    /**
     ...
     */
    function ChildRelation(children, relationTypes) {
    ...
    */
    ChildRelation.prototype.getChildren = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, fetcher.getNode(this.children[i])];
                    case 2:
                        node = _a.sent();
                        result.push(node);
                        _a.label = 3;
    ...
    */
    ChildRelation.prototype.getRelationType = function () {
