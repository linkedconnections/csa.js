...
var Session = /** @class */ (function () {
    ...
    Session.prototype.size = function () {
        return this.nodes.length;
    };
    Session.prototype.getNodes = function () {
        return this.nodes;
    };
    Session.prototype.getMembers = function () {
        var _this = this;
        var members = [];
        this.nodes.forEach(function (element) { return __awaiter(_this, void 0, void 0, function () {
            var m;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, element.getMembers()];
                    case 1:
                        m = _a.sent();
    ...
    Session.prototype.getChildRelations = function () {
        var _this = this;
        var members = [];
        this.nodes.forEach(function (element) { return __awaiter(_this, void 0, void 0, function () {
            var m;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, element.getChildRelations()];
                    case 1:
                        m = _a.sent();
                        m.forEach(function (a) {
                            members.push(a);
